...
// Estimation
%--------------------------------------------------------------------------
estimation(datafile='fsdat.mat',mh_replic=500000,mh_nblocks=3,mh_jscale=0.72,mode_compute = 0,mode_check,plot_priors = 1,mode_file=tank_uh_mode);%,load_mh_file);
