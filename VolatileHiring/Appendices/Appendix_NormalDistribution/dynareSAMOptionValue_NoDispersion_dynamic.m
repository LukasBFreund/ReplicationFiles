...
T22 = y(8)^(1-params(3));
T155 = params(8)*getPowerDeriv(y(7),params(3),1);
T162 = getPowerDeriv(y(8),1-params(3),1);
lhs =y(7);
...
residual(19)= lhs-rhs;
lhs =y(20);
rhs =(1-params(5))*params(9)*(steady_state(12))/(1-(1-params(4))*params(1))+y(23);
residual(20)= lhs-rhs;
lhs =y(23);
...
if nargout >= 4,
  ...
  v3(2,1)=2;
  v3(2,2)=8303;
  v3(2,3)=(-(T162*params(8)*getPowerDeriv(y(7),params(3),2)));
  v3(3,1)=2;
  v3(3,2)=7148;
  v3(3,3)=  v3(2,3);
  v3(4,1)=2;
  ...
  v3(5,1)=2;
  v3(5,2)=8337;
  v3(5,3)=(-(T155*getPowerDeriv(y(8),1-params(3),2)));
  v3(6,1)=2;
  v3(6,2)=7182;
  v3(6,3)=  v3(5,3);
  v3(7,1)=2;
