function [residual, g1, g2] = dynareSAMOptionValue_NoDispersion_static(y, x, params)
%
...
T177 = (-((1-params(5))*params(9)/(1-(1-params(4))*params(1))));
lhs =y(4);
...
if nargout >= 2,
  ...
  g1(21,20)=1-(1-params(4))*params(1);
  g1(22,16)=(-params(1));
  g1(22,22)=1;
  g1(23,2)=(-1);
  g1(23,23)=1;
