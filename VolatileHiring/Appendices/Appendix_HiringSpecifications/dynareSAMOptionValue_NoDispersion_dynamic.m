function [residual, g1, g2, g3] = dynareSAMOptionValue_NoDispersion_dynamic(y, x, params, steady_state, it_)
%
...
T22 = y(8)^(1-params(3));
T152 = params(8)*getPowerDeriv(y(7),params(3),1);
T159 = getPowerDeriv(y(8),1-params(3),1);
lhs =y(7);
...
residual(6)= lhs-rhs;
lhs =y(17);
rhs =(1-params(5))*params(9)*y(15)/(1-(1-params(4))*params(1))+y(18);
residual(7)= lhs-rhs;
lhs =y(18);
rhs =(1-params(5))*(params(9)*y(10)-params(7))+params(1)*(1-params(4))*y(28);
residual(8)= lhs-rhs;
lhs =y(19);
rhs =(1-params(5))*params(9)*y(16)/(1-(1-params(4))*params(1))+y(20);
residual(9)= lhs-rhs;
lhs =y(20);
rhs =(1-params(5))*(params(9)*y(10)-params(7))+params(1)*(1-params(4))*y(29);
residual(10)= lhs-rhs;
lhs =y(21);
rhs =params(1)*y(30)+y(14)*(params(6)/y(9)-(y(19)-params(1)*y(30)));
residual(11)= lhs-rhs;
lhs =params(6);
...
if nargout >= 2,
  ...
  g1(8,18)=1;
  g1(8,28)=(-((1-params(4))*params(1)));
  g1(9,16)=(-((1-params(5))*params(9)/(1-(1-params(4))*params(1))));
  g1(9,19)=1;
  g1(9,20)=(-1);
  g1(10,10)=(-((1-params(5))*params(9)));
  g1(10,20)=1;
  g1(10,29)=(-((1-params(4))*params(1)));
  g1(11,9)=(-(y(14)*(-params(6))/(y(9)*y(9))));
  g1(11,14)=(-(params(6)/y(9)-(y(19)-params(1)*y(30))));
  g1(11,19)=y(14);
  g1(11,21)=1;
  g1(11,30)=(-(params(1)+params(1)*y(14)));
...
if nargout >= 3,
  ...
  v2(11,1)=11;
  v2(11,2)=273;
  v2(11,3)=(-(y(14)*(-((-params(6))*(y(9)+y(9))))/(y(9)*y(9)*y(9)*y(9))));
  v2(12,1)=11;
  v2(12,2)=438;
  v2(12,3)=(-((-params(6))/(y(9)*y(9))));
  v2(13,1)=11;
  v2(13,2)=278;
  v2(13,3)=  v2(12,3);
  v2(14,1)=11;
...
if nargout >= 4,
  ...
  v3(2,1)=2;
  v3(2,2)=7828;
  v3(2,3)=(-(T159*params(8)*getPowerDeriv(y(7),params(3),2)));
  v3(3,1)=2;
  v3(3,2)=6740;
  v3(3,3)=  v3(2,3);
  v3(4,1)=2;
  ...
  v3(5,1)=2;
  v3(5,2)=7861;
  v3(5,3)=(-(T152*getPowerDeriv(y(8),1-params(3),2)));
  v3(6,1)=2;
  v3(6,2)=6773;
  v3(6,3)=  v3(5,3);
  v3(7,1)=2;
  ...
  v3(17,1)=11;
  v3(17,2)=8985;
  v3(17,3)=(-(y(14)*(y(9)*y(9)*y(9)*y(9)*(-(2*(-params(6))))-(-((-params(6))*(y(9)+y(9))))*(y(9)*y(9)*(y(9)+y(9))+y(9)*y(9)*(y(9)+y(9))))/(y(9)*y(9)*y(9)*y(9)*y(9)*y(9)*y(9)*y(9))));
  v3(18,1)=11;
  v3(18,2)=14430;
  v3(18,3)=(-((-((-params(6))*(y(9)+y(9))))/(y(9)*y(9)*y(9)*y(9))));
  v3(19,1)=11;
  v3(19,2)=8990;
  v3(19,3)=  v3(18,3);
  v3(20,1)=11;
