function [residual, g1, g2, g3] = dynareSAMOptionValue_static(y, x, params)
%
...
residual(7)= lhs-rhs;
lhs =y(18);
rhs =(1-params(5))*(params(9)*y(7)-params(7))+params(1)*(1-params(4))*y(18);
residual(8)= lhs-rhs;
lhs =y(15);
...
T184 = (-((1-params(5))*params(9)/(1-(1-params(4))*params(1))));
  g1(1,2)=1-params(4);
  g1(1,4)=1;
  g1(2,1)=1;
  g1(2,4)=(-(T22*params(8)*getPowerDeriv(y(4),params(3),1)));
  g1(2,5)=(-(T19*getPowerDeriv(y(5),1-params(3),1)));
  g1(3,1)=(-(1/y(4)));
  g1(3,4)=(-((-y(1))/(y(4)*y(4))));
  g1(3,8)=1;
  g1(4,1)=(-(1/y(5)));
