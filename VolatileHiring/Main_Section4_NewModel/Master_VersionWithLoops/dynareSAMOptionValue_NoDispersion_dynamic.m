...
T22 = y(8)^(1-params(3));
T153 = params(8)*getPowerDeriv(y(7),params(3),1);
T160 = getPowerDeriv(y(8),1-params(3),1);
lhs =y(7);
...
if nargout >= 4,
  ...
  v3(2,1)=2;
  v3(2,2)=7828;
  v3(2,3)=(-(T160*params(8)*getPowerDeriv(y(7),params(3),2)));
  v3(3,1)=2;
  v3(3,2)=6740;
  v3(3,3)=  v3(2,3);
  v3(4,1)=2;
  ...
  v3(5,1)=2;
  v3(5,2)=7861;
  v3(5,3)=(-(T153*getPowerDeriv(y(8),1-params(3),2)));
  v3(6,1)=2;
  v3(6,2)=6773;
  v3(6,3)=  v3(5,3);
  v3(7,1)=2;
